...
func (_q *CommentQuery) QueryIssue() *IssueQuery {
...
func (_q *CommentQuery) WithIssue(opts ...func(*IssueQuery)) *CommentQuery {
	query := (&IssueClient{config: _q.config}).Query()
...
func (_q *CommentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Comment, error) {
	...
	if query := _q.withIssue; query != nil {
		if err := _q.loadIssue(ctx, query, nodes, nil,
			func(n *Comment, e *Issue) { n.Edges.Issue = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *CommentQuery) loadIssue(ctx context.Context, query *IssueQuery, nodes []*Comment, init func(*Comment), assign func(*Comment, *Issue)) error {
