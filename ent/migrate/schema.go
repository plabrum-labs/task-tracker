...
var (
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{MilestonesColumns[4]},
				RefColumns: []*schema.Column{ProjectsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{MilestonesColumns[1], MilestonesColumns[4]},
			},
		},
	}
	...
	RefsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "kind", Type: field.TypeEnum, Enums: []string{"dep", "subtask"}, Default: "dep"},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{RefsColumns[2]},
				RefColumns: []*schema.Column{IssuesColumns[0]},
				OnDelete:   schema.Cascade,
			},
			{
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{RefsColumns[2], RefsColumns[3]},
			},
		},
	}
...
func init() {
	...
	IssuesTable.ForeignKeys[0].RefTable = MilestonesTable
