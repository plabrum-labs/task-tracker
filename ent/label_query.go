...
func (_q *LabelQuery) QueryIssues() *IssueQuery {
...
func (_q *LabelQuery) WithIssues(opts ...func(*IssueQuery)) *LabelQuery {
	query := (&IssueClient{config: _q.config}).Query()
...
func (_q *LabelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Label, error) {
	...
	if query := _q.withIssues; query != nil {
		if err := _q.loadIssues(ctx, query, nodes,
			func(n *Label) { n.Edges.Issues = []*Issue{} },
			func(n *Label, e *Issue) { n.Edges.Issues = append(n.Edges.Issues, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *LabelQuery) loadIssues(ctx context.Context, query *IssueQuery, nodes []*Label, init func(*Label), assign func(*Label, *Issue)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(label.IssuesTable)
		s.Join(joinT).On(s.C(issue.FieldID), joinT.C(label.IssuesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(label.IssuesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(label.IssuesPrimaryKey[1]))
