...
// was not loaded in eager-loading.
func (e IssueEdges) SubtasksOrErr() ([]*Issue, error) {
	if e.loadedTypes[5] {
...
// QuerySubtasks queries the "subtasks" edge of the Issue entity.
func (_m *Issue) QuerySubtasks() *IssueQuery {
	return NewIssueClient(_m.config).QuerySubtasks(_m)
}
