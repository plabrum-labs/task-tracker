...
func (m *IssueMutation) AddSubtaskIDs(ids ...int) {
	if m.subtasks == nil {
...
// ClearSubtasks clears the "subtasks" edge to the Issue entity.
func (m *IssueMutation) ClearSubtasks() {
	m.clearedsubtasks = true
}

// SubtasksCleared reports if the "subtasks" edge to the Issue entity was cleared.
func (m *IssueMutation) SubtasksCleared() bool {
	return m.clearedsubtasks
}

// RemoveSubtaskIDs removes the "subtasks" edge to the Issue entity by IDs.
func (m *IssueMutation) RemoveSubtaskIDs(ids ...int) {
...
// RemovedSubtasks returns the removed IDs of the "subtasks" edge to the Issue entity.
func (m *IssueMutation) RemovedSubtasksIDs() (ids []int) {
...
func (m *IssueMutation) SubtasksIDs() (ids []int) {
...
func (m *IssueMutation) ResetSubtasks() {
	m.subtasks = nil
...
func (m *IssueMutation) AddedEdges() []string {
	...
	if m.subtasks != nil {
		edges = append(edges, issue.EdgeSubtasks)
	}
	if m.blocks != nil {
...
// SetUpdatedAt sets the "updated_at" field.
func (m *RefMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *RefMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the Ref entity.
// If the Ref object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RefMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *RefMutation) ResetUpdatedAt() {
	m.updated_at = nil
}
...
func (m *RefMutation) Fields() []string {
	...
	if m.updated_at != nil {
		fields = append(fields, ref.FieldUpdatedAt)
	}
	if m.blocked != nil {
