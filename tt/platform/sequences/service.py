...
over SQLite instead of async over Postgres. The mechanism is unchanged — upsert
the counter row so it exists, then bump it and read the new value back in one
